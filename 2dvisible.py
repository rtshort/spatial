"""
Program to plot demonstrate visible facets in the Euclidean plane.

Data is generated by selecting the testcase below.  Edit the data generation
parameters for different situations.  Plot elements are selected by using the
mouse and keyboard as described in the final lines when the program is executed.
...
from plotutils import convex_hull_plot_2d
