"""
visible2d - Python 3 script to demonstrate visible facets of convex hulls in the Euclidean plane.
=================================================================================================
...
for parameter entry) to change the generated data.  If testcase==2 the
data is read from the qhull file specified in the code.  Edit the file
