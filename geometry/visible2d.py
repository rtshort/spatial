...
visible2d - Demonstrate visible facets in 2d
============================================

This script generates a set of points in 2 dimensions (the Euclidean
plane), computes the convex hull, and allows the user to examine each
facet of the hull in turn by using the keyboard.  Facets are
highlighted as being visible or invisible.
